========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта 6.4.4.1.Interfaces_and_virtual_functons_p1
========================================================================

Это приложение 6.4.4.1.Interfaces_and_virtual_functons_p1 создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения 6.4.4.1.Interfaces_and_virtual_functons_p1.


6.4.4.1.Interfaces_and_virtual_functons_p1.vcxproj
...
6.4.4.1.Interfaces_and_virtual_functons_p1.vcxproj.filters
...
6.4.4.1.Interfaces_and_virtual_functons_p1.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем 6.4.4.1.Interfaces_and_virtual_functons_p1.pch и файла предкомпилированных типов с именем StdAfx.obj.
