========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта 6.4.4.2.Interfaces_And_virtual_func_p2
========================================================================

Это приложение 6.4.4.2.Interfaces_And_virtual_func_p2 создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения 6.4.4.2.Interfaces_And_virtual_func_p2.


6.4.4.2.Interfaces_And_virtual_func_p2.vcxproj
...
6.4.4.2.Interfaces_And_virtual_func_p2.vcxproj.filters
...
6.4.4.2.Interfaces_And_virtual_func_p2.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем 6.4.4.2.Interfaces_And_virtual_func_p2.pch и файла предкомпилированных типов с именем StdAfx.obj.
