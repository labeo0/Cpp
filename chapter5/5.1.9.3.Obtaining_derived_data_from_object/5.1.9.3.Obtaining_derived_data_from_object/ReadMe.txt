========================================================================
    КОНСОЛЬНОЕ ПРИЛОЖЕНИЕ. Обзор проекта 5.1.9.3.Obtaining_derived_data_from_object
========================================================================

Это приложение 5.1.9.3.Obtaining_derived_data_from_object создано автоматически с помощью мастера приложений.

В этом файле представлена сводка содержимого всех файлов, входящих в состав приложения 5.1.9.3.Obtaining_derived_data_from_object.


5.1.9.3.Obtaining_derived_data_from_object.vcxproj
...
5.1.9.3.Obtaining_derived_data_from_object.vcxproj.filters
...
5.1.9.3.Obtaining_derived_data_from_object.cpp
...
StdAfx.h, StdAfx.cpp
    Эти файлы используются для построения файла предкомпилированного заголовка (PCH) с именем 5.1.9.3.Obtaining_derived_data_from_object.pch и файла предкомпилированных типов с именем StdAfx.obj.
